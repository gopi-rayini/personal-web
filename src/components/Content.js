            ...
            <div className={`content ${page.state ? 'show' : 'hide'}`}>
                ...
                {page.id === 2 && 
                 <FadeDownDiv className={page.button}>
                    ...
                    <h1 className="slight-right">Skills</h1>
                    <div className="icon-bg">
                        <div className="icons-wrapper">                        
                            <svg className="ic" viewBox="0 0 128 128">
                ...
                {page.id === 3 && 
                 <FadeDownDiv className={page.button}>
                     <div className="socials-wrapper">
                           ...
                           <a href="https://twitter.com/qtKhanna">       
